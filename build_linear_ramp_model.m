function build_linear_ramp_model()
    % build_linear_ramp_model - BMW i3 EV Model with Linear Ramp Cycle
    
    model_name = 'bmw_i3_linear_ramp_model';
    ...
    set_param(model_name, 'StopTime', '40'); % Linear Ramp duration
    
    % Load Parameters
    fprintf('Loading parameters for Linear Ramp cycle...\n');
    [vehicle, ~] = setup_full_params();
    
    % Override with Linear Ramp cycle
    cycle = generate_linear_ramp_cycle();
